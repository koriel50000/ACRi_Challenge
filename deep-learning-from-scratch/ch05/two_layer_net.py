...
class TwoLayerNet:
    ...
    def __init__(self, input_size, hidden_size, output_size, weight_init_std = 0.01):
        ...
        self.layers['Affine1'] = Affine2(self.params['W1'])
        self.layers['BatchNorm1'] = BatchNormalization(self.params['gamma1'], self.params['beta1']);
        self.layers['Relu1'] = Relu()
        self.layers['Affine2'] = Affine2(self.params['W2'])
    ...
    def gradient(self, x, t):
        ...
        self.params['mean1'] = self.layers['BatchNorm1'].running_mean
        self.params['var1'] = self.layers['BatchNorm1'].running_var
